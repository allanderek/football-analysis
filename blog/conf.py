...
BLOG_AUTHOR = "allanderek"  # (translatable)
BLOG_TITLE = "Football Data Site"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://allanderek.github.io/football-analysis/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://example.com/"
BLOG_EMAIL = "allan.clark@gmail.com"
BLOG_DESCRIPTION = "I basically just graph some of the data freely available for football leagues, I might even make the occasional comment."  # (translatable)
